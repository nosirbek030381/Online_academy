...
<html lang="en">
  ...
  <body>
    <center>
      ...
      <div class="form-group col-sm-6">
        <input type="text" name="name" class="form-control" id="name" placeholder="Ismingizni kiriting">
      </div>
      <div class="form-group col-sm-6">
        <span id="staticField" type="text" name="occupation" class="form-control" id="organization">A1 Tech group</span>
      </div>

      <a href="" target="_blank" rel="noopener noreferrer">
      <button type="submit" name="generate" class="btn btn-primary">Generate</button></a>
    </form>
    <br>
    <?php
      if (isset($_POST['generate'])) {
        ...
        if ($name == "" && $occupation == "A1 Tech group" ) {
          echo
          "
          ...
          $text2 = imagettftext($createimage, (float) $font_size_occupation, $rotation, $origin1_x+2, $origin1_y, $black, $drFont1, $occupation);
 ...
 ?>
        ...
        <a href="<?php echo $output; ?>" target="_blank" class="btn btn-success">Kursi Tugatganlik Sertifikatini olish</a>
        <br><br>
<?php
        }
      }
     ...
     ?>
      ...
      <footer>
          <center><p>Hamkorimiz    <a href="#">A1 Tech group</a></p></center>
      </footer>
